          ...
          >
            ...
            <blockquote className="space-y-6">
              <p className="text-3xl font-medium leading-[1.3] tracking-tight">
                "Initializing the system... deploying confidence protocols. CareerSpeak is the definitive tool for engineering your communication."
              </p>
              <footer className="text-sm text-zinc-500 font-mono flex flex-col mt-6">
                <span className="text-zinc-300 font-medium">sys_admin_log</span>
                <span>/users/sofia/review.txt</span>
              </footer>
            </blockquote>
          </motion.div>
        </div>
